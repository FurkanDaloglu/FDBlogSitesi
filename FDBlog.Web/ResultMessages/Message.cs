namespace FDBlog.Web.ResultMessages
{
    public static class Message
    {
        public static class Article
        {
            ...
            {
                return $"{articleTitle} başlıklı makale başarıyla geri döndürülmüştür.";
            }
        }
        public static class Category
        {
            ...
            {
                return $"{categoryName} başlıklı kategori başarıyla geri döndürülmüştür.";
            }
        }
