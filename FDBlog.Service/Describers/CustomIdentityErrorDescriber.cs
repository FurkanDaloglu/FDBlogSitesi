...
namespace FDBlog.Service.Describers
{
    public class CustomIdentityErrorDescriber:IdentityErrorDescriber
    {
        public override IdentityError PasswordRequiresUniqueChars(int uniqueChars)
        {
            return new IdentityError { Code = "PasswordRequiresUniqueChars", Description = $"Parola en az {uniqueChars} farklı karakter içermelidir." };
        }
        ...
        {
            return new IdentityError { Code = "PasswordTooShort", Description = $"Parola çok kısa (en az {lenght} karakter olmalı)." };
        }
